...
-- dataquality/infrastructure/io/metadata_sources.py → _default_query_template()
--
-- To enable this file, configure it in the execution JSON:
...
WHERE
	...
	-- ('dwc_dimensao')
    -- ('nfecorp') -- NFECORP
    -- ('dmt_arrecada') -- EXASISIF
    -- ('dimp', 'suanota', 'tramita', 'sgt') -- EXABDP
    -- ('cadastro', 'conta_corrente', 'copaf', 'dte', 'ipva2', 'itcd2', 'receita2', 'seta', 'sinfa', 'sipaj', 'sisagua', 'siscoex2', 'sisseg', 'sitram2')  -- EXAPROD
    -- ('sped') -- EXASISIF
    -- ('sgs') -- GOOGLE CLOUD
GROUP BY 
    atc.OWNER,
